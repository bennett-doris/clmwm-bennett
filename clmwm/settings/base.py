...
SECRET_KEY = 'n!rt)ey^!&hm)$lh)_71y36=s^uheb3(1l&m3eaz%+69)w7q%o'
...
TEMPLATES = [
    {
        ...
        # 'DIRS': [os.path.join(BASE_DIR,'clmwm/templates')],       # 添加模板目录引用
        'DIRS':[r'C:\Users\Administrator\PycharmProjects\clmwm\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [r'C:\Users\Administrator\PycharmProjects\clmwm\static']
